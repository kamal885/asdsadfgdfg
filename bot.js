...
client.on("message", message => {
 if (message.content === '2help') {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setDescription(`
2play ⇏ لتشغيل أغنية برابط أو بأسم
2skip ⇏ لتجاوز الأغنية الحالية
2pause ⇏ ايقاف الأغنية مؤقتا
2resume ⇏ لمواصلة الإغنية بعد ايقافها مؤقتا
2vol ⇏ لتغيير درجة الصوت 100 - 0
2stop ⇏ لإخرآج البوت من الروم
2np ⇏ لمعرفة الأغنية المشغلة حاليا
2queue ⇏ لمعرفة قائمة التشغيل
 `)
